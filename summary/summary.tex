...
\usepackage{fancyhdr}
\pagestyle{fancy}
\rhead{\bfseries Tausch - A halo exchange library}
\lhead{Lukas Spies}
...
\begin{figure}[ht]\centering
    ...
    \end{tikzpicture}
    \caption{Schematic of how to compute on CPU and GPU concurrently in separate threads \label{fig:threadsschematic}}
\end{figure}
