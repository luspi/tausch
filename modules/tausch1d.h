...
public:
     ...
     */
    void postReceive(TauschDeviceDirection flags, size_t haloId, int mpitag = -1);
     ...
     */
    void postAllReceives(TauschDeviceDirection flags, int *mpitag = nullptr);
     ...
     *
     */
    void send(TauschDeviceDirection flags, size_t haloId, int mpitag = -1);
     ...
     *
     */
    void packAndSend(TauschDeviceDirection flags, size_t haloId, buf_t *buf, TauschPackRegion region, int mpitag = -1);
    void packAndSend(TauschDeviceDirection flags, size_t haloId, buf_t *buf, int mpitag = -1);
    void packAndSend(TauschDeviceDirection flags, size_t haloId, cl::Buffer buf, int mpitag = -1);
