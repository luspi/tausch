...
TEST_CASE("CUDA-to-CUDA, 1 buffer, with pack/unpack, same MPI rank") {
...
TEST_CASE("CUDA-to-CUDA, 1 buffer, with pack/unpack, multiple MPI ranks") {
...
TEST_CASE("CUDA-to-CUDA, 2 buffers, with pack/unpack, same MPI rank") {
...
TEST_CASE("CUDA-to-CUDA, 2 buffers, with pack/unpack, multiple MPI ranks") {
