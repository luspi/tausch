...
TEST_CASE("1 buffer, with pack/unpack, same MPI rank, neighborhood collectives") {

    std::cout << " * Test: " << "1 buffer, with pack/unpack, same MPI rank, neighborhood collectives" << std::endl;
...
TEST_CASE("1 buffer, with pack/unpack, multiple MPI ranks, neighborhood collectives") {

    std::cout << " * Test: " << "1 buffer, with pack/unpack, multiple MPI rank, neighborhood collectives" << std::endl;
...
TEST_CASE("2 buffers, with pack/unpack, same MPI rank, neighborhood collectives") {

    std::cout << " * Test: " << "2 buffers, with pack/unpack, same MPI rank, neighborhood collectives" << std::endl;
...
TEST_CASE("2 buffers, with pack/unpack, multiple MPI ranks, neighborhood collectives") {

    std::cout << " * Test: " << "2 buffers, with pack/unpack, multiple MPI rank, neighborhood collectives" << std::endl;
