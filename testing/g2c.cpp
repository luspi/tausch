...
TEST_CASE("1 buffer data exchange") {
    ...
    REQUIRE(testC2C_1buf(sendIndices1, recvIndices1, expected1) == 0);
    ...
    REQUIRE(testC2C_1buf(sendIndices2, recvIndices2, expected2) == 0);
    ...
    REQUIRE(testC2C_1buf(sendIndices3, recvIndices3, expected3) == 0);
...
TEST_CASE("2 buffer data exchange") {
    ...
    REQUIRE(testC2C_2buf(sendIndices1, recvIndices1, expected1_1, expected1_2) == 0);

    std::vector<int> sendIndices2 = {0,2,4,6,8};
    std::vector<int> recvIndices2 = {1,3,5,7,9};
    double *expected2_1 = new double[10]{1,11,3,13,5,15,7,17,9,19};
    double *expected2_2 = new double[10]{11,1,13,3,15,5,17,7,19,9};
    REQUIRE(testC2C_2buf(sendIndices2, recvIndices2, expected2_1, expected2_2) == 0);
