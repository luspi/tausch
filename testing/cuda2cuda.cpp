...
int test_1buf(std::vector<int> sendIndices, std::vector<int> recvIndices, double *expected) {
    ...
    tausch->addLocalHaloInfoCUDA(sendIndices, 1, -1, TauschOptimizationHint::StaysOnDevice);
    tausch->addRemoteHaloInfoCUDA(recvIndices, 1, -1, TauschOptimizationHint::StaysOnDevice);
...
int test_2buf(std::vector<int> sendIndices, std::vector<int> recvIndices, double *expected1, double *expected2) {
    ...
    tausch->addLocalHaloInfoCUDA(sendIndices, 2, -1, TauschOptimizationHint::StaysOnDevice);
    tausch->addRemoteHaloInfoCUDA(recvIndices, 2, -1, TauschOptimizationHint::StaysOnDevice);
