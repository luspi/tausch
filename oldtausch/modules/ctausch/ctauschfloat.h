...
int tausch_addLocalHaloInfo1D_CwC_float(CTauschFloat *tC, TauschHaloSpec haloSpec);
int tausch_addLocalHaloInfo2D_CwC_float(CTauschFloat *tC, TauschHaloSpec haloSpec);
int tausch_addLocalHaloInfo3D_CwC_float(CTauschFloat *tC, TauschHaloSpec haloSpec);
...
void tausch_delLocalHaloInfo1D_CwC_float(CTauschFloat *tC, size_t haloId);
void tausch_delLocalHaloInfo2D_CwC_float(CTauschFloat *tC, size_t haloId);
void tausch_delLocalHaloInfo3D_CwC_float(CTauschFloat *tC, size_t haloId);


/****************************************/
// setRemoteHaloInfo*

int tausch_addRemoteHaloInfo1D_CwC_float(CTauschFloat *tC, TauschHaloSpec haloSpec);
int tausch_addRemoteHaloInfo2D_CwC_float(CTauschFloat *tC, TauschHaloSpec haloSpec);
int tausch_addRemoteHaloInfo3D_CwC_float(CTauschFloat *tC, TauschHaloSpec haloSpec);
...
void tausch_delRemoteHaloInfo1D_CwC_float(CTauschFloat *tC, size_t haloId);
void tausch_delRemoteHaloInfo2D_CwC_float(CTauschFloat *tC, size_t haloId);
void tausch_delRemoteHaloInfo3D_CwC_float(CTauschFloat *tC, size_t haloId);
...
void tausch_packSendBuffer1D_GwC_float(CTauschFloat *tC, size_t haloId, size_t bufferId, cl_mem *bufcl);
void tausch_packSendBuffer2D_GwC_float(CTauschFloat *tC, size_t haloId, size_t bufferId, cl_mem *bufcl);
void tausch_packSendBuffer3D_GwC_float(CTauschFloat *tC, size_t haloId, size_t bufferId, cl_mem *bufcl);
